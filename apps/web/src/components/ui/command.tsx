...
// Local edit to the generated component: `commandProps` forwards options to the
// inner <Command> (we need `shouldFilter={false}` — the ranking is minisearch's,
// not cmdk's). Re-apply if `command` is ever pulled again.
